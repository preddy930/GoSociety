package com.gosociety.server.common.util;
...
public class GoSoHttpClient {
	...
	public String postRequest(String domain, String path, Map<String,String>requestparams, boolean https) throws GoSoHttpClientException {
		...
		try {
			...
			throw new GoSoHttpClientException(e,uri);
		} catch (IOException e) {
			throw new GoSoHttpClientException(e,uri);
		}
	...
	public String getRequest(String domain, String path, Map<String,String>requestparams, boolean https) throws GoSoHttpClientException 
	{
		URI uri=null;
